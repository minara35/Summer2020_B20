...
public class Collection_Methods {
    public static void main(String[] args) {
        ...
        students.addAll(Arrays.asList("Aslan", "Bilan", "Alan", "Minara", "Zeliha"));
       //                               0           1      2        3       4

        Collections.swap(students, 1,4); // swaps 1 name with 4 name
        Collections.swap(students, 1,4);// swaps 1 nme with 4 name
        Collections.swap(students, 0, students.size()-1); // swaps 0 nme with 4 name
